...
EXEC sys.sp_addextendedproperty @name=N'Description', @value=N'Ñïèñîê îðãàíèçàöèé' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Company'
GO
...
EXEC sys.sp_addextendedproperty @name=N'Description', @value=N'Ñïèñîê áàç äàííûõ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'DBMS'
GO
...
EXEC sys.sp_addextendedproperty @name=N'Description', @value=N'Ñïèñîê ðàçðàáîò÷èêîâ' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'Developer'
GO
